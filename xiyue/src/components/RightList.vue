 ...
 * @Author: your name
 * @Date: 2019-09-30 13:25:11
 * @LastEditTime: 2019-10-12 21:46:30
...
<template>
    <div class="rightlistBox">
        <section >
            <div class="r1-head">
                <img :src="this.$store.state.themeObj.center_smailimg?this.$store.state.themeObj.center_smailimg:'static/img/22.jpg'" alt="">
